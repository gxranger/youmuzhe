...
Component({
    ...
    // 新建百度地图对象 
        ...
        var success = function(data) { 
            ...
            cityInfo.cityName = data.originalData.result.addressComponent.city;
            cityInfo.longitude = wxMarkerData[0].longitude;
            cityInfo.latitude = wxMarkerData[0].latitude;
            cityInfo.status = true;
            that.getCity(cityInfo);
            let listData = that.data.data;
            that.resetRight(listData);
        } 
        // 发起regeocoding检索请求 
        BMap.regeocoding({ 
            fail: fail, 
